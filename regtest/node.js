...
var BitcoinRPC = require('.counoscoind-rpc');
var index = require('..');
  ...
  describe('Address Functionality', function() {
    ...
    it('correctly give the history for the address', function(done) {
      ...
      node.getAddressHistory(address, options, function(err, results) {
        ...
        info.tx.feeSatoshis.should.be.within(9500, 40000); // TODO: Not sure how the fee is calculated in counoscoind, start at rpcwallet.cpp sendtoaddress()
        done();
      });
    });
