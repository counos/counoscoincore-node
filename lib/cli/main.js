...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `counoscoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ counoscoincore-node add wallet-service');
      console.log('    $ counoscoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ counoscoincore-node remove wallet-service');
      console.log('    $ counoscoincore-node remove insight-api');
      console.log();
    });
